...
class GUIGameOverScreen extends GUIObject {
    ...
    display(){
        ...
        textSize(40);
        text("Your final score was: " + scoreCounter.score.toFixed(0), width/2, height/2+60);
        
        textSize(40);
        text(`You survived ${(survivalTimer.survivalTime/1000).toFixed(2)} seconds`, width/2, height/2+110);

        textSize(40);
        text(`Press any key to restart`, width/2, height-80);
